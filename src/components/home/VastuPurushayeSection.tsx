...
<div className={`${isMobile ? 'flex flex-col md:flex-row items-center' : 'flex flex-col px-44 md:flex-row items-center'}`}>
<Slide direction="left">
<div className={`${isMobile ? 'w-full md:w-1/2 mb-6 md:mb-0 md:mr-8 flex justify-center md:justify-start' : 'md:w-1/2 mb-6 md:mb-0 md:mr-8'}`}>
<img
src={WEB_IMAGE.lakshmi} // Replace with your image URL
alt="Vastu Purushaye"
className={`${isMobile ? 'rounded-lg shadow-lg transform scale-100 md:scale-110 hover:scale-105 transition-transform duration-500 max-w-sm md:max-w-full object-cover' : 'rounded-lg shadow-lg transform scale-[2.7] hover:scale-[2.8] transition-transform duration-500'}`}
/>
</div>
</Slide>

<Slide direction="right">
<div className={`${isMobile ? 'w-full md:w-1/2' : 'md:w-full p-7'}`}>
<p className={`${isMobile ? 'text-base md:text-lg' : 'text-xl'} text-gray-700 mb-4 leading-relaxed`}>
...
<p className={`${isMobile ? 'text-base md:text-lg' : 'text-xl'} text-gray-700 leading-relaxed`}>
