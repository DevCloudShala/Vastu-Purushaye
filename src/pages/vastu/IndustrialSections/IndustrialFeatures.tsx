...
const features = [
  {
    ...
    description: "Streamline operations with an energy-aligned layout."
  },
  {
    image: "https://images.unsplash.com/photo-1579532537598-459ecdaf39cc?ixlib=rb-1.2.1&auto=format&fit=crop&w=720&q=80",
    title: "Improve Efficiency",
    description: "Reduce delays and improve workflow by placing key areas strategically."
  },
  {
    ...
    description: "Correct Vastu imbalances to reduce operational challenges."
  },
  {
    ...
    description: " Build a solid foundation for continued prosperity."
  }
];
